...
class SampleQuestionsController
{
    private const STORAGE_DIR = 'sample-questions';
    private const CATEGORIES = ['primary', 'lower-secondary', 'upper-secondary'];
    private const TYPES = ['questions', 'answers'];

    public function index(): Response
    {
        return Inertia::render('admin/simple-q-a', [
        ...
        foreach (self::CATEGORIES as $category) {
            foreach (self::TYPES as $type) {
                ...
                $files[] = [
                    ...
                    'exists' => $exists,
                    'downloadUrl' => $exists
                        ? '/sample-questions/'.$category.'/'.$type
                        : null,
                    'updatedAt' => $exists
